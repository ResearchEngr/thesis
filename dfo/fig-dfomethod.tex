...
\node[root] {\large \textbf{ Derivative Free Optimization}}
% The first level, as children of the initial tree
  child {node[level 2] (c1) {Direct Search}}
  child {node[level 2] (c2) {Model Search}}
  child {node[level 2] (c3) {Heuristics}}
  child {node[level 2] (c4) {Global Search}};
...
\node [below of = c11,yshift=-5pt] (c12) {Generating Set Search}; %with bound constraints
\node [below of = c12,yshift=0pt] (c13) {Mesh Adaptive};
